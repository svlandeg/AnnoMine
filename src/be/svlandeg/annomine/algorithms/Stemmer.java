...
/**
 * This class wraps a private class "PorterStemmer" to apply stemming
 */
public class Stemmer
{

	/**
	 * Return the stemmed version of the given word, using the Porter Stemming algorithm.
	 * 
	...
	public String stem(String word)
	{
		...
		ps.add(result.toCharArray(), result.length());
		ps.stem();
		return ps.toString();
	}
	...
	{
		System.out.println(new Stemmer().stem("induced"));
		System.out.println(new Stemmer().stem("induction"));
	}
	...
	History:
	  Release 1
		...
		The words 'aed', 'eed', 'oed' leave k at 'a' for step 3, and b[k-1] is then out outside the bounds of b.
	  Release 2
	...
	private class PorterStemmer
	{
		...
		/** 
		 * cvc(i) is true <=> i-2,i-1,i has the form consonant - vowel - consonant and also if the second c is not w,x or y. this is used when trying to restore an e at the end of a short word. 
